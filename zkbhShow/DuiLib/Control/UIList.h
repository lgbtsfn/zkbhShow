...
#define UILIST_MAX_COLUMNS 32
	...
	public:
			CDuiString m_Num;//序号
			CDuiString m_Floor;//楼编号
			CDuiString m_floorNum;//楼层
			CDuiString m_devNum;//设备编号
			CDuiString m_devIp;//设备IP
			CDuiString m_Time;//视频录制时间
			CDuiString m_Status;//查看状态
			CDuiString m_fileName;//文件名_10_32_54.mp4
	};
